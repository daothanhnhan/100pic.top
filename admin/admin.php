        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    case "xoa-danh-muc-tin-tuc":
                        include_once("template/danh-muc-tin-tuc/xoa-danh-muc-tin-tuc.php");
                        break;
                    ...
                    case "xoa-danh-muc-san-pham":
                        include_once("template/danh-muc-san-pham/xoa-danh-muc-san-pham.php");
                        break;
                    ...
                    ///////////// goi gia /////////////////
                    case "goi-gia":
                        include_once("template/goi-gia/goi-gia.php");
                        break;
                    case "loai-goi":
                        include_once("template/goi-gia/loai-goi.php");
                        break;
                    ///////////// goi mua /////////////////
                    case "goi-mua":
                        include_once("template/goi-mua/goi-mua.php");
                        break;
                    case "sua-ngay":
                        include_once("template/goi-mua/sua-ngay.php");
                        break;
                    ///////////// kich co /////////////////
                    case "kich-co":
                        include_once("template/kich-co/kich-co.php");
                        break;
                    case "them-kich-co":
                        include_once("template/kich-co/them-kich-co.php");
                        break;
                    case "sua-kich-co":
                        include_once("template/kich-co/sua-kich-co.php");
                        break;
                    case "xoa-kich-co":
                        include_once("template/kich-co/xoa-kich-co.php");
                        break;
                    /////////////// import ////////////////
                    case "import":
                        ...
                        break;
					case "import-video":
                        include_once("template/import/video.php");
                        break;
                    ///////////// loi ich /////////////////
                    case "loi-ich":
                        include_once("template/loi-ich/loi-ich.php");
                        break;
                    case "them-loi-ich":
                        include_once("template/loi-ich/them-loi-ich.php");
                        break;
                    case "sua-loi-ich":
                        include_once("template/loi-ich/sua-loi-ich.php");
                        break;
                    case "xoa-loi-ich":
                        include_once("template/loi-ich/xoa-loi-ich.php");
                        break;
                    /////////////// xoa all san phẩm //////
                    ...
                    case "xoa-all-ma-khuyen-mai":
					 ...
					 ///////////// video cat ///////////////
                    case "video-cat":
                        include_once("template/video-cat/video-cat.php");
                        break;
                    case "them-video-cat":
                        include_once("template/video-cat/them-video-cat.php");
                        break;
                    case "sua-video-cat":
                        include_once("template/video-cat/sua-video-cat.php");
                        break;
                    case "xoa-video-cat":
                        include_once("template/video-cat/xoa-video-cat.php");
                        break;
                    ////////////// video tab //////////////
                    case "video-tab":
                        include_once("template/video-tab/video-tab.php");
                        break;
                    case "them-video-tab":
                        include_once("template/video-tab/them-video-tab.php");
                        break;
                    case "sua-video-tab":
                        include_once("template/video-tab/sua-video-tab.php");
                        break;
                    case "xoa-video-tab":
                        include_once("template/video-tab/xoa-video-tab.php");
                        break;
                    ///////////// video app ///////////////
                    case "video-app":
                        include_once("template/video-app/video-app.php");
                        break;
                    case "them-video-app":
                        include_once("template/video-app/them-video-app.php");
                        break;
                    case "sua-video-app":
                        include_once("template/video-app/sua-video-app.php");
                        break;
                    case "xoa-video-app":
                        include_once("template/video-app/xoa-video-app.php");
                        break;
                    /////////////// video /////////////////
                    case "video":
                    ...
                    case "xoa-video":
                        ...
                        break;
                    ///////////// sửa url /////////////////
                    case "sua-url-san-pham":
                        include_once("template/san-pham/sua-url.php");
                        break;
                    //////////// ma khuyen mai ////////////
                    case "ma-khuyen-mai":
                    ...
                    ///////////// user code ///////////////
                    case "user-code":
                        include_once("template/user-code/user-code.php");
                        break;
                    /////////// tai khoan user ////////////
                    case "xoa-user-price":
                        include_once("template/tai-khoan-user/xoa-loi-nhuan.php");
                        break;
                    ///////////// Default /////////////////
                    default:
