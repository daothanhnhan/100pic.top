                            ...
                            <?php 
                                ...
                                ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <textarea name="lang[<?= $lang['languages_code']?>][lang_web_name]" id="input" class="form-control" rows="3"><?= $rowDetailLang['lang_web_name'];?></textarea>

                                        <p class="titleRightNCP">Keyword</p>

                                        <textarea name="lang[<?= $lang['languages_code']?>][lang_web_keyword]" id="input" class="form-control" rows="3"><?= $rowDetailLang['lang_web_keyword'];?></textarea>
                                        ...
                                        <p class="titleRightNCP">Giới thiệu công ty</p>
							            ...
							            <p class="titleRightNCP">Chịu trách nhiệm</p>
							            ...
							            <p class="titleRightNCP">Giấy phép</p>
...
<form action="" method="post" enctype="multipart/form-data" id="updateConfig">
    ...
    <div class="rowNodeContentPage">
     ...
     <div class="rowNodeContentPage">
        ...
        <div class="leftNCP">
            ...
            <span class="titLeftNCP">Momo</span>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Yêu cầu thiết kế riêng video</p>

            <input type="text" class="txtNCP1" value="<?php echo $row_showMain['lang_content_home4']?>" name="content_home4"/>



            <p class="titleRightNCP">Hướng dẫn thanh toán</p>
            ...
            <p class="titleRightNCP">Chuyển khoản</p>
            ...
            <p class="titleRightNCP">Yêu cầu thiết kế riêng ảnh</p>
