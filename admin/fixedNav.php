<div class="fixedLeft">
    <div class="contentFL" style="height: 85%;overflow-y: scroll;">
        <ul class="listMenuFL">
           ...
           <!-- <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <li><a href="index.php?page=kich-co" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Kích cỡ</a>
            </li>

            <li><a href="index.php?page=import" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Import</a>
            </li>
            ...
            <!-- <li><a href="index.php?page=ho-so" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Hồ sơ</a>
            </li>
            ...
            <li><a href="index.php?page=quan" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Quận</a>
            </li>

            <li><a href="index.php?page=phuong" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Phường</a>
            </li>

            <li><a href="index.php?page=sieu-thi" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Siêu thị</a>
            </li>

            <li><a href="index.php?page=cua-hang" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Cửa hàng</a>
            </li> -->
            ...
            <li><a href="index.php?page=loai-goi" title="" class="linkMenu <?php if ($_GET["page"] == 'loai-goi') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Loại gói</a>
            </li>

            <li><a href="index.php?page=goi-mua" title="" class="linkMenu <?php if ($_GET["page"] == 'goi-mua') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Gói mua</a>
            </li>

            <li><a href="index.php?page=loi-ich" title="" class="linkMenu <?php if ($_GET["page"] == 'loi-ich') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Lợi ích</a>
            </li>
			
			<li><a href="index.php?page=video-cat" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Danh mục video</a>
            </li>

            <li><a href="index.php?page=video-tab" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Loại video</a>
            </li>

            <li><a href="index.php?page=video-app" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>App Video</a>
            </li>
			...
			<li><a href="index.php?page=import-video" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Import video</a>
            </li>
            ...
            <li><a href="index.php?page=user-code" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Mã khách hàng</a>
            </li>
...
<div class="logoTop">
    <a href="/" class="linkLogoTop"><img src="image/logo.png" class="imgLogoTop" style="width: 66%;" /></a>
