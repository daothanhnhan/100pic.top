...
class action_page extends library{
	...
	/*--------------- Sản phẩm --------------------*/
		...
		public function addProduct(){
			...
			$product_date = isset($_POST['product_date']) ? $_POST['product_date'] : '0000-00-00';

			$kich_co_id = isset($_POST['kich_co_id']) ? $_POST['kich_co_id'] : '0';
   ...
   //          }
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddsssisiiisssssssssssssssssisissssi');
		...
		public function updateProduct(){
			...
			$product_date = isset($_POST['product_date']) ? $_POST['product_date'] : '';
