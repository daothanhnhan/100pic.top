<?php 
    ...
    $kich_co = $action->getList('product_size', '', '', 'id', 'asc', '', '', '');
?>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
           ...
           <!--  <p class="titleRightNCP">Danh mục</p>
            ...
            <p class="titleRightNCP">Link ảnh đại diện Drive:</p>

            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor1" name="product_img_1" style="height: 60px;"><?php echo $row['product_img_1'];?></textarea></p>
            ...
            <p class="titleRightNCP">Link sản phẩm download:</p>

            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor1" name="product_des2"><?php echo $row['product_des2'];?></textarea></p>
        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <input type="date" class="txtNCP1" value="<?php echo $row['product_date'];?>" name="product_date" required/>
                ...
                <div class="subColContent">
                    ...
                    <select name="kich_co_id" class="txtNCP1">
                        <option value="0">Chọn kích cỡ</option>
                        <?php foreach ($kich_co as $item) { ?>
                        <option value="<?= $item['id'] ?>" <?= $item['id']==$row['kich_co_id'] ? 'selected' : '' ?> ><?= $item['name'] ?></option>
                        <?php } ?>
                    </select>
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_new" <?= $row['product_new'] == 1 ? 'checked' : '' ?>>Sản phẩm free
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_hot" <?= $row['product_hot'] == 1 ? 'checked' : '' ?>>Sản phẩm khuyến mãi
