<?php 
	...
	function kich_co () {
		...
		if (isset($_POST['add_size'])) {
			...
			$sql = "INSERT INTO product_size (name) VALUES ('$name')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một kích cỡ.\');window.location.href="index.php?page=kich-co"</script>';
			} else {
