...
$cart_id = 0;
                    for($row =2; $row <= $total_rows; $row++) {
                        $query = "insert into `video` (name, link_video, download, des, content, video_cat_id, video_tab_id, video_app_id, `range`, goi, link) VALUES ";
                        //Read a single row of data and store it as a array.
                        //This line of code selects range of the cells like A1:D1
                        $single_row = $sheet->rangeToArray('A' . $row . ':' . $total_columns . $row, NULL, TRUE, FALSE);
                        echo "<tr>";
                        ...
                        // $sql_vn = "INSERT INTO product_languages (lang_product_name, lang_product_des2, lang_product_content, languages_code, product_id) VALUES ".$query1."'vn', $product_id)";
                        //  mysqli_query($conn_vn, $sql_vn);
                        // $sql_en = "INSERT INTO product_languages (lang_product_name, lang_product_des2, lang_product_content, languages_code, product_id) VALUES ".$query1."'en', $product_id)";
