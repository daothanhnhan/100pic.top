<?php 
	...
	function code_sale () {
		...
		if (isset($_POST['add_sale'])) {
			...
			$sql = "INSERT INTO code_sale (code, `money`, percent, name, note) VALUES ('$code', '$money', $percent, '$name', '$note')";
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" class="txtNCP1" name="name" value="" />
            ...
            <input type="number" class="txtNCP1" name="money" id="money" onkeyup="moneyf1(this)" value="0" required/> -->
            <p class="titleRightNCP">Phần trăm</p>
            <input type="number" name="percent" min="0" max="100" class="txtNCP1" value="0" required="">
