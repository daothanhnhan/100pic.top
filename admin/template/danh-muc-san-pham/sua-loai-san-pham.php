...
<?php
    ...
    $row = $action->getDetail_New('productcat', array('productcat_id'), array(&$productcat_id), 'i');//var_dump($row['productcat_sub_info1']);
    if ($row == '') {
...
<form action="" method="post" accept-charset="utf-8" id="updateProductCat">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Giá danh mục</p>
            <input type="number" name="productcat_sub_info1" class="txtNCP1" value="<?= $row['productcat_sub_info1'] ?>">
        </div>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                <label class="selectCate">
                    <input type="checkbox" value="1" name="loc" <?= $row['loc'] == 1 ? 'checked' : '' ?>>Hiện phần lọc
                </label>
            </div>
        </div>
    </div><!--end rowNodeContentPage-->
