<?php 
	...
	function video_app () {
		...
		if (isset($_POST['add_video_cat'])) {
			...
			$sql = "INSERT INTO video_app (name, link) VALUES ('$name', '$link')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một app video.\');window.location.href="index.php?page=video-app"</script>';
			} else {
