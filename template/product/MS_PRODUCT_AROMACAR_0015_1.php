...
<div class="pictures_tab row">
    ...
    <div class="im ">
        <img src="https://acamotion.net/wp-content/uploads/2017/09/h%E1%BB%8Dc-thi%E1%BA%BFt-k%E1%BA%BF-%C4%91%E1%BB%93-h%E1%BB%8Da-660x330.png"
            alt="Avatar" data-toggle="modal" data-target="#modal-11" onclick=""  data-toggle="modal" data-target="#modal-11" onclick="" class="image" style="width:100%">
    ...
    <div class="im ">
        <img src="https://vbs.asia/wp-content/uploads/2019/10/thiet-ke-banner-quang-cao-vbs-11.jpg" alt="Avatar" data-toggle="modal" data-target="#modal-11" onclick="" 
    ...
    <div class="im ">
        <img src="https://picas.com.vn/wp-content/uploads/2018/11/Banner-quang-cao-giay-Dr.Martens-1290x800.png"
            alt="Avatar" data-toggle="modal" data-target="#modal-11" onclick=""  class="image" style="width:100%">
        <div class="info-hover">
            <div class="middle">
                <ul>
                                       <li><i class="fa fa-heart-o" aria-hidden="true">
    ...
    <div class="im ">
        <img src="https://gotrangtri.vn/wp-content/uploads/2017/11/Banner-khuy%E1%BA%BFn-m%E1%BA%A1i-27-11-378-x-235px.png"
            alt="Avatar" data-toggle="modal" data-target="#modal-11" onclick=""  class="image" style="width:100%">
        <div class="info-hover">
            <div class="middle">
                <ul>
    ...
    <div class="im ">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcS-ZHRoNGcqfr_ANa661OkIEx4h6PASt113T-Fv2-ZTRFIMfzoU"
            alt="Avatar" data-toggle="modal" data-target="#modal-11" onclick=""  class="image" style="width:100%">
        <div class="info-hover">
            <div class="middle">
                <ul>
    ...
    <div class="im ">
        <img src="https://vemaybayvietmy.com/wp-content/uploads/2018/11/khuyen-mai-jetstar-mung-dai-le.png" alt="Avatar" data-toggle="modal" data-target="#modal-11" onclick="" 
            class="image" style="width:100%">
        <div class="info-hover">
            <div class="middle">
                <ul>
    ...
    <div class="im ">
        <img src="https://sanvemaybay.vn/includes/uploads/2016/02/Jetstar-11k.png" alt="Avatar" data-toggle="modal" data-target="#modal-11" onclick=""  class="image"
            style="width:100%">
        <div class="info-hover">
            <div class="middle">
                <ul>
    ...
    <div class="im ">
        <img src="https://lh3.googleusercontent.com/proxy/Vgzp70EO1tJ-y35l5D-GPUt44hVHd0IPIK0U9Ayn4AR9kIedVCFzzN8sl-y3fcgLnoDimKLbnTcRvANLNrQmpXs1ztz6cWC_8EwLYg9Te6N_5X2VXmwP456ziJVs-vpok7H6WYQ"
            alt="Avatar" data-toggle="modal" data-target="#modal-11" onclick=""  class="image" style="width:100%">
        <div class="info-hover">
            <div class="middle">
                <ul>
    ...
    <div class="im ">
        <img src="http://3.bp.blogspot.com/-_cIB1U90kcI/VJlhzVLVwOI/AAAAAAAAP9A/UILOCXGXjv8/s1600/hinh-anh-3d-dep-voi-mau-sac-lung-linh-dac-sac-1.jpg"
            alt="Avatar" data-toggle="modal" data-target="#modal-11" onclick=""  class="image" style="width:100%">
        <div class="info-hover">
            <div class="middle">
                <ul>
