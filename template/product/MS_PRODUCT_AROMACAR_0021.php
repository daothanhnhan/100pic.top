...
<div class="pictures_1 row">
    ...
    foreach ($product_list_popup['data'] as $item_popup) { 
        if ($item_popup['product_img'] == '') {
            $link_anh_sale_1 = $item_popup['product_img_1'];
        } else {
            $link_anh_sale_1 = '/images/'.$item_popup['product_img'];
        }
    ?>
    <div class="im ">
        <img src="<?= $link_anh_sale_1 ?>" alt="Avatar" onclick="load_img_sale(<?= $item_popup['product_id'] ?>)" class="image"
            style="width:100%">
