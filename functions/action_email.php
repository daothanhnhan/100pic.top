...
class action_email 
{
        function email_send ($email_to, $title = "", $content = "") {
                $nFrom = "100pic.top";    //mail duoc gui tu dau, thuong de ten cong ty ban
                $mFrom = 'quenmatkhau@100pic.top';  //dia chi email cua ban 
                $mPass = 'quenmatkhau100pic.top';       //mat khau email cua ban
                ...
                $mail->AddReplyTo('quenmatkhau@100pic.top', '100pic.top'); //khi nguoi dung phan hoi se duoc gui den email nay
